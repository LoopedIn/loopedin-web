...
const AddFriend = props => {
  ...
  const [userFriendsState, setUserFriendsState] = React.useState(
  ...
  return (
    <Grid
      container
      spacing={5}
      style={{ backgroundColor: "#cfe8fc", padding: 100 }}
      justify="center"
    >
      {/* Main grid */}
      <Grid item xs={3}>
        <Paper className={classes.paper_add_users_card}>
          <Grid container>
            <Grid item xs={12} style={{ textAlign: "left" }}>
              <Typography variant="h6">Add more friends here!!</Typography>
            </Grid>
